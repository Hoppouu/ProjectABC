...
public class PlayerController : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        {
            GameManager.inst.inputHandler.OnRunInput += Run;
            GameManager.inst.inputHandler.OnWalkInput += Walk;
            GameManager.inst.inputHandler.OnMouseInput += RotateBody;
            GameManager.inst.inputHandler.OnJumpInput += Jump;
        }
    }
